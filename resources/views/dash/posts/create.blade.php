    ...
    <div class="container">
                ...
                <form action="{{ route('posts.store') }}" class="w-50" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control {{ ($errors->has('name')) ? 'is-invalid' : '' }}" id="name" name="name" placeholder="Asus">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control {{ ($errors->has('price')) ? 'is-invalid' : '' }}" id="price" name="price" placeholder="5000">
                        <span class="invalid-feedback">
                            {{ $errors->first('price') }}
                        </span>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control {{ ($errors->has('qt'))  ? 'is-invalid' : ''}}" id="qt" name="qt" placeholder="1" min="1">
                        <span class="invalid-feedback">
                            {{ $errors->first('qt') }}
                        </span>
                    </div>
